...
function modify_user_contact_methods($methods)
{
	...
	$methods['author_heading'] = __('Author Heading');
...
add_filter('the_content', 'add_author_block');
function add_author_block($content)
{

	$name = get_the_author_meta('display_name');
	$description = get_the_author_meta('user_description');
	$avatar = get_avatar(get_the_author_meta('ID'), 192);
	$instagram = get_the_author_meta('instagram');
	$facebook = get_the_author_meta('facebook-f');
	...
	$before = "
	<div class='he-author-wrap'>
	<div class='he-author-left'>
	<span class='abt-the-author'>About The Author</span>
	{$avatar}
	</div>
	<div class='he-author-right'>
	<h3 class='he-author-heading'>{$heading}</h3>
	<p class='he-author-description'>{$description}</p>
		<ul>

		<li class='he-instagram'>
		<a href='{$instagram}'>
